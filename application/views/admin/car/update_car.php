<div class="col-9 mt-5 mx-auto">
    <div class="card">
        <div class="card-body">
        <?php echo form_open('admin/car/update/'.$car->id);?>
            <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                                            ...
                                            <?php foreach ($type as $type) : ?>
                                                <option value="<?php echo $type->id ?>" <?php if ($car->type_id == $type->id) {
                                                  echo "selected";
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="car_number" value="<?php echo $car->car_number;?>">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="car_color" value="<?php echo $car->car_color;?>">
                    </div>
                ...
                <div class="form-group">
                                            ...
                                            <select class="custom-select" name="car_status">
                                                ...
                                                <option value="Inactive" <?php if ($car->car_status == "Inactive") {
                                                  echo "selected";
                                                } ;?>>Inactive</option>
                                            </select>
                                            </div>
